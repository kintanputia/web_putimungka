<x-app-layout>
    <x-slot name="header">
        <h4 class="font-semibold text-lg text-gray-800 leading-tight">
            Selamat Datang di Website UMKM Puti Mungka
        </h4>
    </x-slot>
                        ...
                        <h2 class="font-semibold text-gray-800 leading-tight text-center mb-5">Produk Terbaru Kami</h2>
                            ...
                            @endforeach
                                ...
                                <div class="mx-auto p-3">
                                    <a class="btn btn-success btn-lg float-right mr-3" href="/katalogproduk" data-abc="true">Lebih Banyak Produk <i class="fa fa-arrow-right ml-2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
