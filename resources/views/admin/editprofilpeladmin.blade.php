            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <h5>Edit Profil Pelanggan</h5>
                        <!-- upp -->
                        <form method="post" name="frm_editp" id="frm_editp" action="/editprofilpadm_process" enctype="multipart/form-data" onsubmit="validasi()">
                            @csrf
                                <div class="overflow-hidden sm:rounded-md">
                                        <div class="grid grid-cols-6 gap-6">
                                        <input type="hidden" name="id" id="id" value="{{ $data->id_pelanggan }}">
