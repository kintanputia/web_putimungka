...
class CreateDetailTransaksiAdminsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('detail_transaksi_admins', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('detail_transaksi_admins');
    }
}
